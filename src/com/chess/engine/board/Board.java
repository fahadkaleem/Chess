...
public class Board {
    ...
    public static Board createStandardBoard() {
        ...
        builder.setPiece(new Queen(Alliance.BLACK, 2));
        ...
        builder.setPiece(new Queen(Alliance.WHITE, 50));
        builder.setPiece(new King(Alliance.WHITE, 51));
        builder.setPiece(new Bishop(Alliance.WHITE, 52));
        builder.setPiece(new Knight(Alliance.WHITE, 53));
        builder.setPiece(new Rook(Alliance.WHITE, 54));
